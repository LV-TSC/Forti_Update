...
BackupVPN = os.path.isfile("C:\\WTS\\VPN\\MiVPN.conf")
    ...
    try:
        ...
        if FortiClientx64 == True:
            ...
            if versionx64 < 7:
                ...
                os.system('"FCConfig -m all -f "C:\\WTS\\VPN\\MiVPN.conf" -o export -i 1 -p Nuevo.123"')
                uninstallVPN()
        ...
        if FortiClientx64 == False:
            CREATE_NO_WINDOW = 0x08000000
            subprocess.call('C:\WTS\VPN\FortiClientVPN.exe /quiet /norestart', creationflags=CREATE_NO_WINDOW)

            ###RESTORE CONFIG###
            os.chdir("C:\\Program Files\\Fortinet\\FortiClient")
            if BackupVPN == True:
                os.system('"FCConfig -m all -f "C:\WTS\VPN\MiVPN.conf" -o import -i 1 -p Nuevo.123"')
            else:
                os.system('"FCConfig -m all -f "C:\WTS\VPN\VPN.conf" -o import -i 1 -p Nuevo.123"')
